...
def multi_flex(df) :
    ...
    store1 = [df[0,"title"], df[0,"link"],df[0,"rating"],df[0,"address"],df[0,"nextOpenTime"]]
    store2 = [df[1,"title"], df[1,"link"],df[1,"rating"],df[1,"address"],df[1,"nextOpenTime"]]
    store3 = [df[2,"title"], df[2,"link"],df[2,"rating"],df[2,"address"],df[2,"nextOpenTime"]]
    store4 = [df[3,"title"], df[3,"link"],df[3,"rating"],df[3,"address"],df[3,"nextOpenTime"]]
    store5 = [df[4,"title"], df[4,"link"],df[4,"rating"],df[4,"address"],df[4,"nextOpenTime"]]
